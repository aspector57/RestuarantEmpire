...
namespace RestaurantEmpire.Core.Model
{
    ...
    public sealed class SatisfactionResult
    {
        internal SatisfactionResult(
            decimal foodQuality, decimal serviceSpeed, decimal value,
    ...
    {
        public const decimal FoodQualityWeight = 0.45m;
        public const decimal ServiceSpeedWeight = 0.35m;
        public const decimal ValueWeight = 0.20m;
        ...
        public static SatisfactionResult Evaluate(
            ...
            decimal ingredientQuality, decimal foodCostRatio)
        {
            ...
            if (!ticket.WasServed)
                return new SatisfactionResult(0m, 0m, 0m, 0m, true, ticket.FailureReason);

            // Waited past their limit and gave up.
            if (ticket.WaitMinutes > party.PatienceMinutes)
            {
                return new SatisfactionResult(0m, 0m, 0m, 0m, true,
            ...
            return new SatisfactionResult(quality, speed, value, overall, false,
                Diagnose(dishName, ticket, quality, speed, value));
        }
        ...
        private static string Diagnose(string dishName, Ticket ticket, decimal quality, decimal speed, decimal value)
        {
