...
namespace RestaurantEmpire.Core.Model
{
    ...
    public sealed class SimulationRunner
    {
        ...
        private Interrupt Tick()
        {
            ...
            if (window != null) _laborCost += _restaurant.HourlyWageBill / 60m;
        ...
        private Interrupt Seat(long tick, DateTime now)
        {
            ...
            foreach (var recipeId in _restaurant.Menu.RecipeIds)
            {
                ...
                // for the one thing a party orders — that would make a drinks list cannibalize
                ...
                var appetite = party.AppetiteFor(candidate, relative,
                    _restaurant.Costing.IngredientQuality(recipeId), _restaurant.Country);
        ...
        /// so a fine-dining room and a pizzeria drew the identical street and specializing was
