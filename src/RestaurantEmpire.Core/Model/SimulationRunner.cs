...
namespace RestaurantEmpire.Core.Model
{
    ...
    public sealed class SimulationRunner
    {
        ...
        private decimal _revenue, _foodCost, _wastedFoodCost, _satisfactionTotal, _labourCost;
        ...
        {
            get { return _restaurant.Company.Economy.CashOnHand + _revenue - _foodCost - _labourCost; }
        }
        ...
        public ServiceResult Snapshot()
        {
            return new ServiceResult(
                ...
                _revenue, _foodCost, _wastedFoodCost, _labourCost,
        ...
        private Interrupt Tick()
        {
            ...
            // time labour is GENERATED by the simulation rather than approximated by a
            // caller, which is what finally makes prime cost honest.
            var window = CurrentWindow();
            if (window != null) _labourCost += _restaurant.Payroll.HourlyWageBill / 60m;
